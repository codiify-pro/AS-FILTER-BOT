...
PICS = (environ.get('PICS', 'https://img.odivex.com/img/img_68482167cb28c8.15981119.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2021145517 7258504951 6103866763').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002890420554').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/blogger_theme_finder')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/odivax')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'oditalk) # Support Chat Link Without https:// or @
