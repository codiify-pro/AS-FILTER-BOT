...
I’m an advanced Blogger theme finder bot. Just send me the name of any theme you’re looking for, and I’ll process your request and deliver the exact theme you need.</b>"""
...
Nᴀᴍᴇ - {}"""
    ...
    ALRT_TXT = """ʜᴇʟʟᴏ {},
ᴛʜɪꜱ ɪꜱ ɴᴏᴛ ʏᴏᴜʀ THEME ʀᴇQᴜᴇꜱᴛ,
ʀᴇQᴜᴇꜱᴛ ʏᴏᴜʀ'ꜱ..."""
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ..."""
    ...
    MVE_NT_FND = """THEME ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ..."""

    TOP_ALRT_MSG = """Cʜᴇᴄᴋɪɴɢ Fᴏʀ THEME Iɴ Dᴀᴛᴀʙᴀsᴇ..."""
...
பிளாகரில் உங்கள் சொந்த வலைத்தளத்தை உருவாக்குங்கள், வலைப்பதிவு இடுகைகளை எழுதத் தொடங்குங்கள், உங்கள் ஆர்வத்தை வருமானமாக மாற்றுங்கள். உங்கள் அறிவைப் பகிர்ந்து கொள்ளுங்கள், உங்கள் பார்வையாளர்களை வளர்த்துக் கொள்ளுங்கள், விளம்பரங்கள், இணைப்பு சந்தைப்படுத்தல் மற்றும் ஸ்பான்சர் செய்யப்பட்ட உள்ளடக்கம் மூலம் பணம் சம்பாதிக்கவும் - இவை அனைத்தும் உங்கள் வீட்டின் வசதியிலிருந்தே."""

    ENGLISH_INFO = """
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 

Create your own website on Blogger, start writing blog posts, and turn your passion into income. Share your knowledge, grow your audience, and earn money through ads, affiliate marketing, and sponsored content — all from the comfort of your home. """

    TELUGU_INFO = """
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 


 బ్లాగర్‌లో మీ స్వంత వెబ్‌సైట్‌ను సృష్టించండి, బ్లాగ్ పోస్ట్‌లు రాయడం ప్రారంభించండి మరియు మీ అభిరుచిని ఆదాయంగా మార్చుకోండి. మీ జ్ఞానాన్ని పంచుకోండి, మీ ప్రేక్షకులను పెంచుకోండి మరియు ప్రకటనలు, అనుబంధ మార్కెటింగ్ మరియు స్పాన్సర్ చేసిన కంటెంట్ ద్వారా డబ్బు సంపాదించండి - అన్నీ మీ ఇంటి సౌకర్యం నుండే.."""

    HINDI_INFO = """
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 


ब्लॉगर पर अपनी खुद की वेबसाइट बनाएं, ब्लॉग पोस्ट लिखना शुरू करें और अपने जुनून को आय में बदलें। अपना ज्ञान साझा करें, अपने दर्शकों की संख्या बढ़ाएँ और विज्ञापनों, सहबद्ध विपणन और प्रायोजित सामग्री के माध्यम से पैसे कमाएँ - यह सब अपने घर बैठे आराम से।"""

    MALAYALAM_INFO = """
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 


 ബ്ലോഗറിൽ നിങ്ങളുടെ സ്വന്തം വെബ്‌സൈറ്റ് സൃഷ്ടിക്കുക, ബ്ലോഗ് പോസ്റ്റുകൾ എഴുതാൻ തുടങ്ങുക, നിങ്ങളുടെ അഭിനിവേശം വരുമാനമാക്കി മാറ്റുക. നിങ്ങളുടെ അറിവ് പങ്കിടുക, പ്രേക്ഷകരെ വർദ്ധിപ്പിക്കുക, പരസ്യങ്ങൾ, അഫിലിയേറ്റ് മാർക്കറ്റിംഗ്, സ്പോൺസർ ചെയ്ത ഉള്ളടക്കം എന്നിവയിലൂടെ പണം സമ്പാദിക്കുക - എല്ലാം നിങ്ങളുടെ വീടിന്റെ സുഖസൗകര്യങ്ങളിൽ നിന്ന്."""

    URTU_INFO = """
 <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 


Blogger پر اپنی ویب سائٹ بنائیں، بلاگ پوسٹس لکھنا شروع کریں، اور اپنے شوق کو آمدنی میں بدلیں۔ اپنے علم کا اشتراک کریں، اپنے سامعین میں اضافہ کریں، اور اشتہارات، ملحقہ مارکیٹنگ، اور اسپانسر شدہ مواد کے ذریعے پیسہ کمائیں — یہ سب کچھ اپنے گھر کے آرام سے۔"""

    GUJARATI_INFO = """
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 


 બ્લોગર પર તમારી પોતાની વેબસાઇટ બનાવો, બ્લોગ પોસ્ટ લખવાનું શરૂ કરો, અને તમારા જુસ્સાને આવકમાં ફેરવો. તમારા જ્ઞાનને શેર કરો, તમારા પ્રેક્ષકો વધારો, અને જાહેરાતો, એફિલિએટ માર્કેટિંગ અને પ્રાયોજિત સામગ્રી દ્વારા પૈસા કમાઓ - આ બધું તમારા ઘરના આરામથી."""

    KANNADA_INFO = """
ಹೇ {message.from_user.mention}

 ಬ್ಲಾಗರ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಸ್ವಂತ ವೆಬ್‌ಸೈಟ್ ರಚಿಸಿ, ಬ್ಲಾಗ್ ಪೋಸ್ಟ್‌ಗಳನ್ನು ಬರೆಯಲು ಪ್ರಾರಂಭಿಸಿ ಮತ್ತು ನಿಮ್ಮ ಉತ್ಸಾಹವನ್ನು ಆದಾಯವಾಗಿ ಪರಿವರ್ತಿಸಿ. ನಿಮ್ಮ ಜ್ಞಾನವನ್ನು ಹಂಚಿಕೊಳ್ಳಿ, ನಿಮ್ಮ ಪ್ರೇಕ್ಷಕರನ್ನು ಬೆಳೆಸಿಕೊಳ್ಳಿ ಮತ್ತು ಜಾಹೀರಾತುಗಳು, ಅಂಗಸಂಸ್ಥೆ ಮಾರ್ಕೆಟಿಂಗ್ ಮತ್ತು ಪ್ರಾಯೋಜಿತ ವಿಷಯದ ಮೂಲಕ ಹಣವನ್ನು ಸಂಪಾದಿಸಿ - ಇವೆಲ್ಲವೂ ನಿಮ್ಮ ಮನೆಯಿಂದಲೇ.."""

    BANGLADESH_INFO = """
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 

 ব্লগারে আপনার নিজস্ব ওয়েবসাইট তৈরি করুন, ব্লগ পোস্ট লেখা শুরু করুন, এবং আপনার আবেগকে আয়ে পরিণত করুন। আপনার জ্ঞান ভাগ করে নিন, আপনার শ্রোতা বৃদ্ধি করুন এবং বিজ্ঞাপন, অ্যাফিলিয়েট মার্কেটিং এবং স্পনসর করা সামগ্রীর মাধ্যমে অর্থ উপার্জন করুন - সবকিছুই আপনার ঘরে বসেই।"""
